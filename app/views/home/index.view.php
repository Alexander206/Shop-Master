                ...
                <ul id="sidebarnav">
                    ...
                    <li class="pt-3">
                        ...
                        <div class="user-profile d-flex no-block dropdown mt-3">
                            <div class="user-pic">
                                <img src="./assets/images/profile/user-6.jpg" alt="users" class="rounded-circle" width="40" />
                            </div>
        ...
        <header class="topbar">
            <div class="with-vertical"><!-- ---------------------------------- -->
                ...
                <nav class="navbar navbar-expand-lg px-lg-0 px-0 py-0">
                    <ul class="navbar-nav">
                        <li class="nav-item ">
                            <a class="nav-link nav-icon-hover sidebartoggler nav-icon-hover " id="headerCollapse" href="javascript:void(0)">
                        ...
                        <li class="nav-item dropdown mega-dropdown d-none d-lg-block">
                            <a class="nav-link" id="drop2" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="col-8">
                                        <div class="ps-7 pt-7">
                                            ...
                                            <div class="row align-items-center py-3">
                                                <div class="col-8">
                                                    <a class="fw-semibold text-dark d-flex align-items-center lh-1" href="./main/page-faq.html"><i class="ti ti-help fs-6 me-2"></i>Frequently Asked Questions</a>
                                                </div>
                                                <div class="col-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between  py-2">
                            <ul class="navbar-nav flex-row d-flex d-lg-none">
                                ...
                                <li class="nav-item dropdown mega-dropdown">
                                    <a class="nav-link " id="drop2" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="d-lg-flex d-none">Mega</span> <iconify-icon icon="solar:alt-arrow-down-outline" class=" ps-1 fs-4 d-lg-flex d-none"></iconify-icon>
                                        <span class="d-lg-none d-flex"><iconify-icon icon="solar:code-scan-line-duotone"></iconify-icon></span>
                                    </a>
                            ...
                            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                                ...
                                <li class="nav-item dropdown ">
                                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src="./assets/images/svgs/icon-flag-en.svg" alt="" width="22px" height="22px" />
                                    </a>
                                    <div class="dropdown-menu pt-0 dropdown-menu-end dropdown-menu-animate-up mt-n1" aria-labelledby="drop2">
                                        ...
                                        <div class="message-body" data-simplebar>
                                            <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                                                ...
                                                <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <span class="fs-3 d-block text-truncate text-truncate">Just see the my new admin!</span>
                                                </div>
                                            </a>
                                            <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                                                ...
                                                <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <span class="fs-3 d-block text-truncate text-truncate">Just a reminder that you have event</span>
                                                </div>
                                            </a>
                                            <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                                                ...
                                                <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <span class="fs-3 d-block text-truncate text-truncate">You can customize this template as you want</span>
                                                </div>
                                            </a>
                                            <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                                        ...
                                        <div class="message-body" data-simplebar>
                                            <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                                                <span class="user-img position-relative d-inline-block">
                                                    <img src="./assets/images/profile/user-1.jpg" alt="user" class="rounded-circle w-100 round" />
                                    ...
                                    <div class="dropdown-menu message-box pt-0 content-dd mailbox dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                        <div class="profile-dropdown position-relative" data-simplebar>
                                            ...
                                            <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                                <img src="./assets/images/profile/user-6.jpg" class="rounded-circle" width="80" height="80" alt="" />
                                                <div class="ms-3">
                ...
                <nav class="sidebar-nav scroll-sidebar container-fluid">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item ">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-calendar.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                        <span class="hide-menu">Calendar</span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-kanban.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-chat.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-email.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                        <span class="hide-menu">Email</span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-notes.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-contact.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-contact2.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/app-invoice.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/page-user-profile.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/page-pricing.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/page-faq.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="./main/page-account-settings.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item ">
                                    <a class="sidebar-link sublink" href="./main/chart-sparkline.html" aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                        <span class="hide-menu">Sparkline Chart</span>
                ...
                <div class="font-weight-medium shadow-none position-relative overflow-hidden mb-4">
                    <div class="card-body px-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="font-weight-medium ">Dashboard</h4>
                            ...
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="ms-auto d-flex no-block align-items-center">
                                        <ul class="list-inline fs-2 dl me-3 mb-0 d-flex gap-1">
                                            <li class="list-inline-item text-info d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="fs-3 me-1"></iconify-icon>
                                                Iphone
                                            </li>
                                            <li class="list-inline-item text-primary d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="fs-3 me-1"></iconify-icon>
                                                Ipad
                                            </li>
                                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 d-md-flex d-lg-block justify-content-between">
                                        <div>
                                            ...
                                            <h6 class="fw-normal text-muted">Current Month Earnings</h6>
                                        </div>
                                        <div>
                                            <h3 class="mt-4 mb-0">1,540</h3>
                                            <h6 class="fw-normal text-muted mb-md-0 mt-md-2 mt-lg-0 mt-0">
                                                Current Month Sales
                                            </h6>
                                        </div>
                                        <a class="btn btn-lg btn-primary mt-3  mb-3" href="javascript:void(0)">Last Month Summary</a>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div>
                                                <span class="text-orange display-5">
                                                    <iconify-icon icon="solar:wallet-outline" class="text-orange iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div>
                                                <span class="text-cyan display-5">
                                                    <iconify-icon icon="solar:ruble-linear" class="text-cyan iconify-xl"></iconify-icon>
                                            </div>
                                            <div>
                                                <span>Referral Earnings</span>
                                                <h3 class="fw-medium mb-0">$769.08</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- col -->
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div>
                                                <span class="text-info display-5">
                                                    <iconify-icon icon="solar:bag-4-outline" class="text-info iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div>
                                                <span class="text-primary display-5">
                                                    <iconify-icon icon="solar:dollar-minimalistic-linear" class="text-primary iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                                <span>Earnings</span>
                ...
                <div class="row">
                        ...
                        <div class="card card-hover w-100">
                            <div class="card-body">
                                ...
                                <div class="row mt-5 pb-1">
                                    ...
                                    <div class="col-lg-6">
                                        <h1 class="display-6 mb-0 fw-medium">45%</h1>
                                        <span>Open Ratio for Campaigns</span>
                                        <ul class="list-style-none">
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="text-muted me-2 fs-3 "></iconify-icon>
                                                Open Ratio <span class="ms-auto">45%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="text-info me-2 fs-3 "></iconify-icon>
                                                Clicked Ratio <span class="ms-auto">14%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="text-orange me-2 fs-3 "></iconify-icon>
                                                Un-Open Ratio <span class="ms-auto">25%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill" class="text-primary me-2 fs-3 "></iconify-icon>
                    ...
                    ">
                                <div class="pt-3 text-center">
                                    <iconify-icon icon="solar:file-text-outline" class="text-orange display-4 "></iconify-icon>
                                    <span class="display-4 d-block fw-medium heading">368</span>
                                    ...
                                    <a href="javascript:void(0)" class="mt-3 btn btn-lg btn-primary">View More Details</a>
                                </div>
                            </div>
                        </div>
                        <!-- ---------------------
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <!-- ---------------------
                          ...
                          ---------------- -->
                        <div class="card text-white card-hover w-100 overflow-hidden">
                            <div class="card-body bg-info">
                                <h4 class="card-title text-white">Revenue Statistics</h4>
                                <div class="d-flex align-items-center mt-2">
                                    <div class="" id="ravenue"></div>
                                    <div class="ms-auto">
                                        <h3 class="fw-medium text-white mb-0">$351</h3>
                    ...
                    <div class="col-lg-4">
                        <!-- ---------------------
                              start Page Views
                          ---------------- -->
                        <div class="card  text-white card-hover overflow-hidden w-100">
                            <div class="bg-cyan">
                                <div class="card-body pb-3">
                                    <h4 class="card-title text-white">Page Views</h4>
                                    <h3 class="text-white mb-0"><iconify-icon icon="ri:arrow-up-line"></iconify-icon> 6548</h3>
                                </div>
                                <div id="views"></div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="me-3">
                                                            <img src="./assets/images/profile/user-1.jpg" alt="user" class="rounded-circle" width="45" />
                                                        </div>
                                                        <div class="">
                                                ...
                                                <td>
                                                    <div class="popover-icon">
                                                        ...
                                                        <a class="btn-circle btn p-0 popover-item" href="javascript:void(0)"><img src="./assets/images/profile/user-2.jpg" class="rounded-circle" width="39" alt="" /></a>
                                                        <a class="btn-circle btn btn-outline-secondary" href="javascript:void(0)">+</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <iconify-icon icon="ri:circle-fill" class="text-orange fs-4" data-bs-toggle="tooltip" data-bs-placement="top" title="In Progress"></iconify-icon>
                                                </td>
                                                <td>35</td>
                                                <td class="">$96K</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="me-3">
                                                            <img src="./assets/images/profile/user-2.jpg" alt="user" class="rounded-circle" width="45" />
                                                        </div>
                                                        <div class="">
                                                ...
                                                <td>
                                                    <iconify-icon icon="ri:circle-fill" class="text-success fs-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Active"></iconify-icon>
                                                </td>
                                                <td>35</td>
                                                <td class="">$96K</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="me-3">
                                                            <img src="./assets/images/profile/user-3.jpg" alt="user" class="rounded-circle" width="45" />
                                                        </div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="me-3">
                                                            <img src="./assets/images/profile/user-4.jpg" alt="user" class="rounded-circle" width="45" />
                                                        </div>
                                                        <div class="">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable position-relative" style="height: 450px;" data-simplebar>
                                    <!--chat Row -->
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                ...
                <div class="d-flex flex-row gap-3 customizer-box" role="group">
                    <div>
                        ...
                        <label class="btn p-9 btn-outline-primary" for="vertical-layout">
                            <iconify-icon icon="solar:slider-vertical-minimalistic-linear" class="icon fs-7 me-2"></iconify-icon>Vertical</label>
                    </div>
                    <div>
