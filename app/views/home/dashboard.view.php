        ...
        <div>
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="../main/page-user-profile.html"
                            aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                                <iconify-icon icon="solar:text-underline-cross-line-duotone"
                                    class="fs-6"></iconify-icon>
                            </span>
                                            ...
                                            <div class="row align-items-center py-3">
                                                <div class="col-8">
                                                    <a class="fw-semibold text-dark d-flex align-items-center lh-1"
                                                        href="../main/page-faq.html"><i
                                                            class="ti ti-help fs-6 me-2"></i>Frequently
                                                        Asked Questions</a>
                                                </div>
                                                <div class="col-4">
                ...
                <nav class="sidebar-nav scroll-sidebar container-fluid">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/app-calendar.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/app-kanban.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/app-contact.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/app-contact2.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/app-invoice.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/page-user-profile.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/page-pricing.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/page-account-settings.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link sublink" href="../main/chart-sparkline.html"
                                        aria-expanded="false">
                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                            <i class="sidebar-icon"></i>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 d-md-flex d-lg-block justify-content-between">
                                        ...
                                        <a class="btn btn-lg btn-primary mt-3 mb-3" href="javascript:void(0)">Last Month
                                            Summary</a>
                                    </div>
                                            ...
                                            <div class="">
                                                <span class="text-orange display-5">
                                                    <iconify-icon icon="solar:wallet-outline"
                                                        class="text-orange iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <span class="text-cyan display-5">
                                                    <iconify-icon icon="solar:ruble-linear"
                                                        class="text-cyan iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <span class="text-info display-5">
                                                    <iconify-icon icon="solar:bag-4-outline"
                                                        class="text-info iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                            ...
                                            <div class="">
                                                <span class="text-primary display-5">
                                                    <iconify-icon icon="solar:dollar-minimalistic-linear"
                                                        class="text-primary iconify-xl"></iconify-icon>
                                                </span>
                                            </div>
                                            <div>
                                                <span>Earnings</span>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="list-style-none">
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill"
                                                    class="text-muted me-2 fs-3"></iconify-icon>
                                                Open Ratio <span class="ms-auto">45%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill"
                                                    class="text-info me-2 fs-3"></iconify-icon>
                                                Clicked Ratio <span class="ms-auto">14%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill"
                                                    class="text-orange me-2 fs-3"></iconify-icon>
                                                Un-Open Ratio <span class="ms-auto">25%</span>
                                            </li>
                                            <li class="mt-3 d-flex align-items-center">
                                                <iconify-icon icon="ri:circle-fill"
                                                    class="text-primary me-2 fs-3"></iconify-icon>
                    ...
                    ">
                                <div class="pt-3 text-center">
                                    <iconify-icon icon="solar:file-text-outline"
                                        class="text-orange display-4"></iconify-icon>
                                    ...
                                    <a href="javascript:void(0)" class="mt-3 btn btn-lg btn-primary">View More
                                        Details</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-cyan">
                                <div class="card-body pb-3">
                                    ...
                                    <h3 class="text-white mb-0">
                                        <iconify-icon icon="ri:arrow-up-line"></iconify-icon>
                                        6548
                                    </h3>
                                </div>
                                <div id="views"></div>
                            ...
                            <div class="comment-widgets scrollable" style="height: 530px" data-simplebar>
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    ...
                                    <div class="comment-text w-100">
                                        ...
                                        <span class="mb-2 d-block">Lorem Ipsum is simply dummy text of the printing and
                                    ...
                                    <div class="col-3 d-flex justify-content-end">
                                        <a class="btn-circle btn-lg btn-primary btn text-white"
                                            href="javascript:void(0)"><iconify-icon
                                                icon="solar:plain-3-line-duotone"></iconify-icon></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="offcanvas-body" data-simplebar style="height: calc(100vh - 80px)">
                ...
                <div class="d-flex flex-row gap-3 customizer-box" role="group">
                    ...
                    <label class="btn p-9 btn-outline-primary" for="light-layout">
                        <iconify-icon icon="solar:sun-2-outline" class="icon fs-7 me-2"></iconify-icon>Light</label>
