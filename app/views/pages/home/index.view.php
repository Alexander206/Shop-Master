...
<script>
    document.addEventListener("DOMContentLoaded", async (event) => {
        ...
        const response = await fetch(`${URL_PATH}/product/listProducts`);
            ...
            return `<div class="col-sm-6 col-xl-4">
                    <div class="card hover-img overflow-hidden rounded-2">
                        <div class="position-relative">
                            <a href="/"><img src="${URL_PATH}/${item.image}" class="card-img-top rounded-0" alt="..." /></a>
                        ...
                        <div class="card-body pt-3 p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                ${item.price} <span class="ms-2 fw-normal text-muted fs-3"><del>$345</del></span>
                                </h6>
