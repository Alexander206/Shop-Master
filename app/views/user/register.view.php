                        ...
                        <div class="auth-max-width  col-sm-8 col-md-6 col-xl-9">
                            ...
                            <form id="registerForm" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="inputLastname" class="form-control" name="inputLastname" type="lastname"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row login_input_phone" id="inputPhone">
                                        <input id="inputPhoneNumber" class="form-control col-auto"
                                            name="inputPhoneNumber" type="tel" required>

                                        <div>
                                            <img id="imageCountryPhone"
                                                src="<?= URL_PATH ?>/assets/images/svgs/flag.svg" alt="">
                                            <input list="optionsList" id="inputCountryPhone" class="form-control col"
                                                name="inputCountryPhone" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="inputConfirmPassword" class="form-control" name="inputConfirmPassword"
                                        type="password" required>
                                </div>

                                <button type="submit"
                                    class="btn btn-primary w-100 py-8 mb-4 rounded-2">Registrarse</button>

                                <div class="d-flex align-items-center">
                                    <p class="fs-4 mb-0 text-dark">¿Ya tienes una cuenta?</p>
                                    <a class="text-primary fw-medium ms-2" href="<?= URL_PATH ?>/user/login">Inicia
                                        sesión</a>
                                </div>
                            </form>
                        </div>
