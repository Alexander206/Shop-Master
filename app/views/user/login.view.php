                        ...
                        <div class="auth-max-width col-sm-8 col-md-6 col-xl-9">
                            ...
                            <form id="loginForm" method="post">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <a class="text-primary fw-medium" href="<?= URL_PATH ?>/user/recover">¿Olvidaste tu contraseña?</a>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <a class="text-primary fw-medium ms-2" href="<?= URL_PATH ?>/user/register">Crea una cuenta</a>
                                </div>
                            </form>
                        </div>
                    </div>
